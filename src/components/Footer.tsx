...
const PATHS: Record<string, { path: string; name: string; newTab?: boolean }[]> = {
    Soothe: [
        ...
        {path: "/author", name: "Author", newTab: true},
    ],
    Links: [
                ...
                <div className="flex flex-col lg:min-w-max">
                    <div className="mb-4 flex items-center gap-2">
                        <Image src="/avatar.jpg" width="32" height="32" className="h-8 w-8 rounded-full md:h-10 md:w-10"
                               alt="Soothe Logo"/>
                        <h1 className="text-2xl font-bold text-slate-300">kewldan</h1>
                    </div>
                    <p className="mb-1 whitespace-pre-line">Soothe is not endorsed nor affiliated with Discord, Inc.</p>
                </div>
